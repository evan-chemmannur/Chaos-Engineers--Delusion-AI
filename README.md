...
# ഇഷ്ടAI 💕 — Understand. Communicate. Connect.
...
- Lets you track relationship **milestones** like "first conversation" and "finally asked them out".
...
For Hardware:
- A computer (any)
- A crush (optional but recommended)
...
# Installation
```bash
git clone https://github.com/evan-chemmannur/Chaos-Engineers--Delusion-AI.git
cd Chaos-Engineers--Delusion-AI
python -m venv venv
